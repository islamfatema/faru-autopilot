...
VOICE = "en-US-AndrewMultilingualNeural"   # warm, natural US narrator (v2 neural - reads, not recites)

BANK = json.load(open(os.path.join(HERE, "scripts_us.json"), encoding="utf-8"))
...
CTAS = ["Save this and share it with someone who needs it today.",
        "Tag someone who needs to hear this. 💪",
        "Follow for your daily dose of motivation.",
        "Subscribe — your future self will thank you.",
        "Which line hit hardest? Comment below. 🔥"]
MOTIV_TAGS = ["motivation", "motivational", "mindset", "discipline", "success",
              "selfimprovement", "inspiration", "quotes", "shorts", "viral", "hardwork", "grind"]

HOOKS = ["Watch till the end. \U0001f525", "Save this. You'll need it.", "This is your sign.",
         "Stop scrolling. Read this.", "You needed to hear this today."]

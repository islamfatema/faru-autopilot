# -*- coding: utf-8 -*-
"""
Rise With Fate - long-form documentary engine (same anti-slideshow rules) (ANTI-SLIDESHOW).
...
VOICE = "en-US-ChristopherNeural"   # deep motivational narrator
...
def main():
    ...
    clips = [build_title(doc["title"], doc.get("subtitle", "RISE WITH FATE"))]
    for i, s in enumerate(shots):
        t = s["type"]; d = s["_dur"]

...
CHANNELS = {
    "us": {
        ...
        "brief": (
            ...
            "\n"
            "THIS IS NOT A FACTS CHANNEL. The assumption you overturn must be "
            "one the viewer holds ABOUT THEMSELVES, never a fact about the "
            "world. The channel drifted into trivia - 'Cold Does Not Actually "
            "Exist', 'The Colour Orange Is Younger Than The Fruit' - which is "
            "interesting and completely wrong here. Nobody comes to a "
            "motivation channel to learn about the electromagnetic spectrum.\n"
            "\n"
            "Its own best performers, and what they have in common:\n"
            "  'You Will Never Feel Ready'                 320 views\n"
            "  'Protect Your Energy Like Your Life'        599 views\n"
            "  'Your No Is As Powerful As Your Yes'        178 views\n"
            "Every one is second person and every one contradicts something the "
            "viewer believes about their own life. Its worst are proverbs that "
            "contradict nothing: 'Fall Seven Times, Stand Up Eight' took 1 view.\n"
            "\n"
            "So the collision is: they think they are lazy - they are exhausted. "
            "They think they lack discipline - they lack sleep. They think they "
            "are behind - they are comparing a Tuesday to somebody's highlight "
            "reel. Name the belief, contradict it, and give them one thing they "
            "can do today. The viewer should finish feeling something about "
            "their own life, not knowing a new fact.\n"
            "\n"
            "The 'something they can try right now' rule still applies, but it "
            ...
            '\n'
            '    Discipline Is Self Respect              898 views   11.1 subscribers per 1,000\n'
    ...
    "fun": {
        ...
        "brief": (
            ...
            'WHAT THIS CHANNEL SHOULD ACTUALLY BE ABOUT - from its own per-video numbers:\n'
            '\n'
            '    Your Skeleton Replaces Itself Every Decade   321 views   6.2 subscribers per 1,000\n'
    ...
    "history": {
        ...
        "brief": (
            ...
            'WHAT THIS CHANNEL SHOULD ACTUALLY BE ABOUT - from its own per-video numbers:\n'
            '\n'
            '    Rome Had Vending Machines 2,000 Years Ago    839 views   3.6 subscribers per 1,000\n'
